...
accelerate launch --main_process_port 29401 --num_processes 2 --mixed_precision fp16 train.py --model DiT-B/4 --feature-path features --register 0 --load-checkpoint
